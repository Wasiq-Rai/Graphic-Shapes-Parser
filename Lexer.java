...
class Lexer {
    ...
    switch (token) {
        ...
        case StreamTokenizer.TT_WORD:
            ...
            if ((tokenizer.sval.toUpperCase()).equals("ISOSCELES"))
                return Token.ISOSCELES;
            else if (tokenizer.sval.toUpperCase().equals("PARALLELOGRAM"))
                return Token.PARALLELOGRAM;
            else if (tokenizer.sval.toUpperCase().equals("REGULARPOLYGON"))
                return Token.REGULARPOLYGON;
